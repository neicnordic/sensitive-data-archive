...
// msgInfoFilePath creates the payload of the ingest message
// by using the payload of the curl request
func msgInfoFilePath(c *gin.Context) (schema.IngestionTrigger, string, error) {
