...
type functions interface {
	...
	// GetFileIDInInbox gets the file id of a file which last known event is either 'registered', 'uploaded', 'disabled' or 'removed'
	...
	GetUserFiles(ctx context.Context, userID, pathPrefix string, allData bool, limit int, cursor string) ([]*SubmissionFileInfo, string, error)
