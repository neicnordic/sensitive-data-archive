...
func (db *pgDb) GetUserFiles(ctx context.Context, userID, pathPrefix string, allData bool, limit int, cursor string) ([]*database.SubmissionFileInfo, string, error) {
	return db.getUserFiles(ctx, nil, userID, pathPrefix, allData, limit, cursor)
}
