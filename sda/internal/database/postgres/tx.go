...
func (tx *pgTx) GetUserFiles(ctx context.Context, userID, pathPrefix string, allData bool, limit int, cursor string) ([]*database.SubmissionFileInfo, string, error) {
	return tx.getUserFiles(ctx, tx.tx, userID, pathPrefix, allData, limit, cursor)
}
