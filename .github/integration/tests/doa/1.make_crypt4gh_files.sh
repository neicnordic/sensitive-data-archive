...
mkdir -p ./sda-doa/test/crypt4gh

cat << EOF > ./sda-doa/test/crypt4gh/crypt4gh.pub.pem
-----BEGIN CRYPT4GH PUBLIC KEY-----
PQFOuEiuAOlghTGU0Z7u2EH5FwBtSlnukpiMAji/ml0=
-----END CRYPT4GH PUBLIC KEY-----
EOF

chmod 444 ./sda-doa/test/crypt4gh/crypt4gh.pub.pem

cat << EOF > ./sda-doa/test/crypt4gh/my.pub.pem
-----BEGIN CRYPT4GH PUBLIC KEY-----
cUSN6pHzlIFgoclIfDSaDtUgAXRa+DUHBhTodeNL52w=
-----END CRYPT4GH PUBLIC KEY-----
EOF

chmod 444 ./sda-doa/test/crypt4gh/my.pub.pem

cat << EOF > ./sda-doa/test/crypt4gh/my.sec.pem
...
chmod 444 ./sda-doa/test/crypt4gh/my.sec.pem

cat << EOF > ./sda-doa/test/crypt4gh/crypt4gh.sec.pem
-----BEGIN CRYPT4GH ENCRYPTED PRIVATE KEY-----
...
chmod 444 ./sda-doa/test/crypt4gh/crypt4gh.sec.pem
