...
# Testing that verify does not loop when re-queueing already verified file
# NB currently will make verify loop be prepared to stop it before it fills out memory with endless logs
