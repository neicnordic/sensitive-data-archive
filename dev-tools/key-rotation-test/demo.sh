...
case_5_ingest_mixed_keys_during_rotation() {
    # ========================================================================
    # CASE 5: Ingest files encrypted with old and new keys, map to dataset
    # ========================================================================
    log_header "CASE 5: Ingestion Pipeline (Old vs. New Key Uploads & Dataset Mapping)"
    ...
    echo -e "\nStep 5.5: Querying database for file UUIDs..."

    # Extract file UUIDs generated by s3inbox insertion
    ...
    echo -e "\nStep 5.6: Triggering Ingestion via API..."
    ...
    echo "Waiting for ingestion, verification, and finalization pipeline workers..."
    sleep 3

    echo -e "\nStep 5.7: Assigning accession IDs..."
    ...
    echo "Waiting for accessioning to finalize..."
    sleep 2

    echo -e "\nStep 5.8: Mapping accessioned files to Dataset ($DATASET_ID)..."
    ...
    echo -e "\nDataset creation complete. Waiting for mapper service sync..."
    sleep 2

    echo -e "\nStep 5.9: Verifying download and decryption of newly mapped files..."
    ...
    echo -e "\n\033[1;32mSUCCESS: Ingestion, accessioning, dataset mapping, and download succeeded for both key versions!\033[0m"
