...
for file_id in 00000000-0000-0000-0000-000000000001 00000000-0000-0000-0000-000000000002 00000000-0000-0000-0000-000000000003 00000000-0000-0000-0000-000000000004; do
  ...
  docker run --rm --name client --network dev_utils_default \
      ...
      neicnordic/pg-client:latest \
      postgresql://postgres:rootpassword@db:5432/sda \
      -t -q -c "INSERT INTO sda.files (id, stable_id, submission_user, \
          submission_file_path, submission_file_size, archive_file_path, \
          archive_file_size, archive_location, decrypted_file_size, backup_path, header, \
          encryption_method) VALUES ('$file_id', 'urn:neic:001-$file_id', 'integration-test', 'file_$file_id.c4gh', \
          1048729, '$file_id', 1049081, '', 1048605, \
          '', '637279707434676801000000010000006c000000000000006af1407abc74656b8913a7d323c4bfd30bf7c8ca359f74ae35357acef29dc5073799e207ec5d022b2601340585ff082565e55fbff5b6cdbbbe6b12a0d0a19ef325a219f8b62344325e22c8d26a8e82e45f053f4dcee10c0ec4bb9e466d5253f139dcd4be', 'CRYPT4GH') RETURNING id;"
