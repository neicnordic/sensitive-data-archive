...
> **_NOTE:_**  The content of the storage/v2 package is copied from the "sda" implementation at [storage v2](../../../../sda/internal/storage/v2) just with deletion of the writer
...
{STORAGE_IMPLEMENTATION},
supported values are "s3", and "posix", eg if an application is to be able to read from both s3 and posix the config would be:
